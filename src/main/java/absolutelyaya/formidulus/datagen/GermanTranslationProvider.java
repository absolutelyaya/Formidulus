...
public class GermanTranslationProvider extends FabricLanguageProvider implements Lang
{
	...
	public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder builder)
	{
		...
		builder.add(desc(ItemAbilities.SOULSTEAL, 0), "Schlage kleine Teile der Seele deines Feindes ab.");
		builder.add(desc(ItemAbilities.SOULSTEAL, 1), "Der Konsum jener heilt den Nutzer erheblich.");
