...
{
	public static final Animation place = Animation.Builder.create(0.35F)
		...
		.addBoneAnimation("root", new Transformation(Transformation.Targets.TRANSLATE, 
			...
			new Keyframe(0.3F, AnimationHelper.createTranslationalVector(0.0F, 7.45F, 1.0F), Transformation.Interpolations.LINEAR),
			new Keyframe(0.35F, AnimationHelper.createTranslationalVector(0.0F, -0.1F, 0.0F), Transformation.Interpolations.LINEAR)
		))
		.addBoneAnimation("root", new Transformation(Transformation.Targets.SCALE, 
			...
			new Keyframe(0.3F, AnimationHelper.createScalingVector(1.0F, 1.2F, 1.0F), Transformation.Interpolations.LINEAR),
